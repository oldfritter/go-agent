...
//
// Example: https://github.com/oldfritter/go-agent/tree/master/_integrations/nrgorilla/v1/example/main.go
package nrgorilla
...
func instrumentRoute(h http.Handler, app oldfritter.Application, name string) http.Handler {
