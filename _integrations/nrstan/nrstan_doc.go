...
// (https://godoc.org/github.com/oldfritter/go-agent/_integrations/nrnats/#StartPublishSegment)
...
// https://github.com/oldfritter/go-agent/blob/master/_integrations/nrstan/examples/main.go
package nrstan
