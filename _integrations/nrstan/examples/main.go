...
import (
	...
	"github.com/oldfritter/go-agent/_integrations/nrnats"
	"github.com/oldfritter/go-agent/_integrations/nrstan"
)
...
func main() {
	// Initialize agent
	cfg := oldfritter.NewConfig("STAN App", mustGetEnv("NEW_RELIC_LICENSE_KEY"))
