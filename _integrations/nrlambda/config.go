...
// NewConfig populates a oldfritter.Config with correct default settings for a
...
func newConfigInternal(getenv func(string) string) oldfritter.Config {
	cfg := oldfritter.NewConfig("", "")
