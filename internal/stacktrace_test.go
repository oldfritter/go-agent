...
import (
	...
	"github.com/oldfritter/go-agent/internal/stacktracetest"
)
...
func TestStacktraceFrames(t *testing.T) {
	...
	inputFrames := []stacktraceFrame{
		{
			File: "/Users/will/Desktop/gopath/src/github.com/oldfritter/go-agent/internal/stacktrace.go",
			Name: "github.com/oldfritter/go-agent/internal.GetStackTrace",
			Line: 17,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/oldfritter/go-agent/internal_txn.go",
			Name: "github.com/oldfritter/go-agent.(*txn).NoticeError",
			Line: 696,
		},
		{
			File: "\u003cautogenerated\u003e",
			Name: "go.(*struct { github.com/oldfritter/go-agent.threadWithExtras }).NoticeError",
			Line: 1,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/oldfritter/go-agent/internal_attributes_test.go",
			Name: "github.com/oldfritter/go-agent.TestAddAttributeSecurityPolicyDisablesInclude",
			Line: 68,
		},
		{
