...
// (https://godoc.org/github.com/nats-io/stan.go#Conn) If the `oldfritter.Application` parameter is non-nil, it will
// create a `oldfritter.Transaction` and end the transaction when the passed function is complete. Example:
//
...
//	}
//	defer sc.Close()
//	app := createTestApp(t)  // oldfritter.Application
...
// (https://godoc.org/github.com/oldfritter/go-agent/v3/integrations/nrnats/#StartPublishSegment)
...
// https://github.com/oldfritter/go-agent/blob/master/v3/integrations/nrstan/examples/main.go
package nrstan
