module github.com/oldfritter/go-agent/v3/integrations/nrstan/examples
...
require (
	...
	github.com/oldfritter/go-agent/v3/integrations/nrnats v0.0.0
...
replace github.com/oldfritter/go-agent/v3/integrations/nrnats => ../../nrnats/
