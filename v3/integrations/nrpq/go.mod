module github.com/oldfritter/go-agent/v3/integrations/nrpq
...
replace github.com/oldfritter/go-agent/v3 v3.3.0 => ../../../v3

replace github.com/oldfritter/go-agent/v3/oldfritter => ../../../v3/oldfritter
